                        ...
                        <Card className="max-w-[600px]">
                            <CardContent className="p-5 xl:p-8">
                                ...
                                <p className="text-sm xl:text-base  text-default-700">
                                    ...
                                    issues with our script, our support team is
                                    available to assist you. They'll respond to
                                    inquiries and provide limited support
                            ...
                            <CardContent className="p-5 xl:p-8">
                                <div>
                                    ...
                                    <p className=" text-sm xl:text-base text-default-700">
                                        ...
                                        addressed on our Discord server. Feel
                                        free to ask any questions about our
                                        template there as well. Join our Discord

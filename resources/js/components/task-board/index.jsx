...
const TaskBoard = ({ boards, tasks, subTasks, comments }) => {
    ...
    const [selectedBoardForTask, setSelectedBoardForTask] =
        React.useState(null);
            ...
            {boards?.length > 0 ? (
                        ...
                        {taskView === "list" &&
                            boards.map((board, i) => (
                                <TaskList
                                    ...
                                    onEdit={openEdit}
                                    length={
                                        filteredTasks(tasks, board.id).length
                                    }
                                >
                                    <TaskTable
                                        boards={boards}
                ...
                <Blank className="max-w-[353px] mx-auto space-y-4">
                    ...
                    <div className=" text-default-600 text-sm">
                        There is no task create. If you create a new task then
                        click this button & create new board.
                    </div>
